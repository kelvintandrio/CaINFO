...
class Upcoming : Fragment() {
    private val upcomingViewModel by lazy {
        ViewModelProviders.of(this,
            MovieVMFactory(movieRepository = ApiRepository(), compositeDisposable = CompositeDisposable(), type = "up coming"))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvUpComing.setupAdapterData<Data.ListCatalog>(R.layout.item_data_movie, requireContext()) {
            data {
            ...
            upcomingViewModel.getDataMovie("up coming").observe(requireActivity(), Observer {
                setData(it)
            })
